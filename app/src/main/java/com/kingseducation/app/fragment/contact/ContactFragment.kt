package com.kingseducation.app.fragment.contact
...
import com.kingseducation.app.constants.InternetCheckClass
...
import com.kingseducation.app.fragment.contact.model.ContactusResponseArray
            ...
            override fun onResponse(
              ...
              //  contactusdescription.addAll(response.body()!!.contactus)
                    ...
                    /*val username= response.body()!!.home.user_details.name
                        PreferenceManager().setuser_id(com.kingseducation.app.fragment.mContext,username)
                        Log.e("Username", PreferenceManager().getuser_id(com.kingseducation.app.fragment.mContext).toString())
    */
                }
                else
                {
