...
//        @SerializedName("school_language_type") val schoolLanguageType: Int = 0,
//        @SerializedName("photo") val photoUrl: String = "",
//        @SerializedName("is_re_enrollment") val isReEnrollment: Int = 0,
//        @SerializedName("selected_option") val selectedOption: String = "",
//        @SerializedName("re_enrollment_data") val reEnrollmentData: ReEnrollmentData = ReEnrollmentData()
//    )
//
...
//        @SerializedName("options") val options: ArrayList<String> = ArrayList()
//    )
    data class ReEnrollment(
