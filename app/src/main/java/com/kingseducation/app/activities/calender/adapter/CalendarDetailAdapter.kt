...
import com.kingseducation.app.activities.calender.adapter.DescriptionCalendar
import com.kingseducation.app.activities.calender.adapter.EndCalendar
import com.kingseducation.app.activities.calender.adapter.StartCalendar
import com.kingseducation.app.activities.calender.adapter.SummaryCalendar
import com.kingseducation.app.activities.calender.adapter.dialogcalendar
import com.kingseducation.app.activities.calender.adapter.endTime16format
import com.kingseducation.app.activities.calender.adapter.endTime8format
import com.kingseducation.app.activities.calender.adapter.outputDateStrend
import com.kingseducation.app.activities.calender.adapter.outputDateStrstart
import com.kingseducation.app.activities.calender.adapter.startTime16format
import com.kingseducation.app.activities.calender.adapter.startTime8format
...
Log.e("suesss","jhgdjgewfjkg")
            ...
            if (StartCalendar.length == 20) {
                ...
                if (calendarArrayList[position].DTSTART.contains("12:00 am") && calendarArrayList[position].DTEND.contains(
                        "12:00 am"
                    )
                ) {
