...
//        }
    ...
    private fun sendNotification(messageBody: String?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            mChannel.lightColor = resources.getColor(R.color.kings_blue)
...
//        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            notificationBuilder.setSmallIcon(R.drawable.login_bg_logo)
            notificationBuilder.color = resources.getColor(R.color.kings_blue)
        } else {
            notificationBuilder.setSmallIcon(R.drawable.login_bg_logo)
            notificationBuilder.color = resources.getColor(R.color.kings_blue)
        }
